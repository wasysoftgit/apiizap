...
class ApiizapSupabaseUser extends BaseAuthUser {
  ApiizapSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> apiizapSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = ApiizapSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
